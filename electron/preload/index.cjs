...
const api = {
  ...
  scraper: {
    ...
    getPopularTags: () => ipcRenderer.invoke("scraper:getPopularTags"),
    ...
    batchSearchBangumi: (options) => ipcRenderer.invoke("scraper:batchSearchBangumi", options),
    ...
    repairCoverCache: () => ipcRenderer.invoke("scraper:repairCoverCache"),
    clearCoverCache: () => ipcRenderer.invoke("scraper:clearCoverCache")
  },
  bangumi: {
